          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-accent rounded-lg shadow-md p-6 border border-gray-200">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg border border-primary-light">
                <p className="text-sm text-center font-medium text-primary">A comissão média dos agenciadores varia de R$ 50,00 até a 10% do valor do frete, dependendo do tipo e distância da carga.</p>
              </div>
            </div>
          </div>
